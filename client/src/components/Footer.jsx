...
export default class Footer extends React.Component {
    ...
    onSubmit(e) {
        ...
        console.log(message);
        //axios.post('http://localhost:4000/add', message).then(res => console.log(res.data));  
        axios.post('https://pers-portfolio.herokuapp.com/add', message).then(res => console.log(res.data));
    }
