...
function handleHover(e) {
  ...
  if (classN.includes('drumMachineImgGif')) { e.target.style.backgroundImage = `url("https://res.cloudinary.com/fjplaurr/image/upload/v1568989863/Web%20Development/Images/Portfolio/Drum%20Machine/drumMachineProd.gif?p${new Date().getTime()}")`; }
  if (classN.includes('quoteMachineImgGif')) { e.target.style.backgroundImage = `url("https://res.cloudinary.com/fjplaurr/image/upload/v1568990523/Web%20Development/Images/Portfolio/Random%20Quote%20Machine/quoteMachineProd_oycuwz.gif?p${new Date().getTime()}")`; }
  if (classN.includes('markdownPreviewerGif')) { e.target.style.backgroundImage = `url("https://res.cloudinary.com/fjplaurr/image/upload/v1568997796/Web%20Development/Images/Portfolio/Mardown%20Previewer/markdownPreviewerProd_whwafa.gif?p${new Date().getTime()}")`; }
  if (classN.includes('personalPortfolioGif')) { e.target.style.backgroundImage = `url("https://res.cloudinary.com/fjplaurr/image/upload/v1569061401/Web%20Development/Images/Portfolio/Personal%20Portfolio/personalPortfolioGif_racnqc.gif?p${new Date().getTime()}")`; }
}
